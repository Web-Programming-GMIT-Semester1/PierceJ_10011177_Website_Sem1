...
switch ($kyma_theme_options['feature_style']) {
    case 1:
        ...
        break;
    case 2:
	$bg_color = $kyma_theme_options['feature_bg_color'] != "" ? 'white_section ' . $kyma_theme_options['feature_bg_color'] : 'gb_gray'; ?>
    <section id="features_section" class="content_section <?php echo esc_attr($bg_color); ?>">
        <?php if ($kyma_theme_options['home_feature_heading']) { ?>
        <div class="title_banner upper centered">
        <div class="content">
            <h2 id="member_title"><?php echo esc_attr($kyma_theme_options['home_feature_heading']); ?></h2>
        </div>
        </div><?php
    } ?>
